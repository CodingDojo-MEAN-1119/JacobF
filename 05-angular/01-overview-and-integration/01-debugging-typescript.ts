...
//myString = 9;
//The problem is that myString is already defined as a type 'string' and won't accept anything else as it's value
myString = "works";
...
//Same as above problem, name parameter only accepts a string value
...
//Insert an empty string where their middleName would be
...
//Jay had the attribute 'belt' instead of 'belts
...
//function 'math' need to be wrapped in curly braces
